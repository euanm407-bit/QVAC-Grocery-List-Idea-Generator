# QVAC Grocery List Idea Generator

Type a meal you're planning and an on-device AI suggests one grocery item you might be forgetting, with a deterministic usefulness meter.
...
Then open http://localhost:29383
